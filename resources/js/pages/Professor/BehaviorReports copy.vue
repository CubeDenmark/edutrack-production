...
<AppLayout :breadcrumbs="breadcrumbs">
     ...
     <!-- Behavior Reports List -->
      <div class="bg-white dark:bg-gray-800 rounded-lg shadow p-6 mb-6">
        <div class="flex justify-between items-center mb-6">
          ...
          <button @click="openAddReportModal" class="px-3 py-1 bg-primary-600 text-white rounded-md text-sm flex items-center gap-1">
 ...
 <!-- Add Report Modal -->
  <div v-if="showAddReportModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg w-full max-w-md p-6">
      <div class="flex justify-between items-center mb-4">
        <h3 class="text-lg font-medium">Create New Behavior Report</h3>
        <button @click="showAddReportModal = false" class="text-gray-500 hover:text-gray-700 dark:hover:text-gray-300">
