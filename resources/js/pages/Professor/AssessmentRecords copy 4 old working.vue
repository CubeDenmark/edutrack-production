...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="w-full p-6 pt-20">
            ...
            <div v-if="currentSection" class="space-y-6">
                ...
                <div class="overflow-hidden rounded-2xl shadow-lg dark:bg-gray-800">
                            ...
                            <div class="flex flex-col justify-between gap-4 md:flex-row md:items-center">
                                <div>
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 class="text-3xl font-semibold text-black md:text-4xl">{{ currentSection.name }}</h1>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex items-center gap-3 rounded-lg bg-transparent px-4 py-2 backdrop-blur-sm">
                                        <span class="text-sm font-medium text-black">Class Average:</span>
                                        <span class="text-xl font-bold text-black">{{ currentSection.averageScore }}%</span>
                                        <span
    ...
    <div
      v-else
      class="h-10 w-10 rounded-full bg-gray-400 flex items-center justify-center text-white font-bold text-sm"
    >
