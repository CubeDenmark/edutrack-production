...
const classSections = ref([
    {
        ...
        assignments: [
            { id: 'midterm', name: 'Multiple Choice', category: 'exam', weight: 30, totalPoints: 100, dueDate: '2023-10-15' },
            { id: 'quiz1', name: 'Essay Question', category: 'quiz', weight: 10, totalPoints: 50, dueDate: '2023-09-20' },
            { id: 'lab', name: 'Problem Solving', category: 'lab', weight: 15, totalPoints: 100, dueDate: '2023-10-05' },
            { id: 'project', name: 'Chapter 1 Questions', category: 'project', weight: 25, totalPoints: 100, dueDate: '2023-11-20' },
        ],
        students: [
            {
                id: '2023001',
    ...
    <div class="flex flex-col md:flex-row md:items-end gap-6">
        ...
        <div class="flex-1 md:w-2/3">
            <div class="flex flex-col gap-6 md:flex-row md:items-end">
                <div class="flex-1">
                    <label class="mb-2 block text-sm font-semibold text-gray-800 dark:text-gray-300">Assessment Items</label>
                    <select
