...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="w-full p-6 pt-20">
            ...
            <div v-if="!currentSection" class="flex h-[calc(100vh-10rem)] w-full flex-col items-center justify-center text-center">
                <div
                ...
                <p class="mb-8 text-lg text-gray-600 dark:text-gray-400">Please select a class section to view and manage grades.</p>
            ...
            <div v-if="currentSection" class="w-full space-y-8">
                            ...
                            <div class="flex w-full flex-col justify-between gap-4 md:flex-row md:items-center">
                                ...
                                <div>
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div>
                                            <h1 class="text-2xl font-bold text-black md:text-3xl">{{ currentSection.name }}</h1>
                                ...
                                <div class="flex items-center gap-4">
                                    <div class="flex items-center gap-2 rounded-lg bg-transparent px-4 py-2 backdrop-blur-sm">
                                        ...
                                        <span class="text-xl font-bold text-black">{{ classAverage }}%</span>
                        ...
                        <div class="flex w-full flex-col gap-4 sm:flex-row">
                            <div class="w-full">
                                ...
                                <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
                                    {{
                                        selectedTerm === 'Final'
                                            ? 'Viewing final grades for all terms'
                                            : `Viewing grades for ${selectedTerm} assessments`
                                    }}
                                </p>
                            </div>
                        </div>
                ...
                <div class="w-full overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-md dark:border-gray-700 dark:bg-gray-800">
                    ...
                    <!-- Footer with Save Button - Only show when Final Grading is selected -->
                    <div
                        v-if="selectedTerm === 'Final'"
                        class="flex w-full items-center justify-between border-t border-gray-200 bg-gray-50 p-8 dark:border-gray-700 dark:bg-gray-800/50"
                    >
                        <!-- Status messages -->
                        <div class="flex items-center">
                        ...
                        >
                            ...
                            <svg v-else xmlns="http://www.w3.org/2000/svg" class="mr-2 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path
                                    stroke-linecap="round"
                                    stroke-linejoin="round"
                                    stroke-width="2"
